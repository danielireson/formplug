...
describe('Email', function () {
  it('should reject an arn that is incorrectly formatted', function () {
    const testSubject = new Email('sender', 'arn')
  ...
  it("should reject an arn that doesn't start with 'arn'", function () {
    const testSubject = new Email('sender', 'other:aws:ses:eu-west-1:123456789123:identity/johndoe@example.com', 'testing')
    const recipients = {to: '', cc: [], bcc: []}
    const userParameters = {}
  ...
  it('should reject an arn with an invalid identity length', function () {
    const testSubject = new Email('sender', 'arn:aws:ses:eu-west-1:123456789123:identity', 'testing')
    const recipients = {to: '', cc: [], bcc: []}
    const userParameters = {}
  ...
  it('should reject an arn with an invalid identity email address', function () {
    ...
    const testSubject = new Email('sender', 'arn:aws:ses:eu-west-1:123456789123:identity/johndoe', 'testing')
    const recipients = {to: '', cc: [], bcc: []}
    const userParameters = {}
  ...
  it('should build the sender source correctly', function () {
    const testSubject = new Email('Formplug', 'arn:aws:ses:eu-west-1:123456789123:identity/johndoe@example.com', 'testing')
    const recipients = {to: '', cc: [], bcc: []}
    const userParameters = {}
  ...
  it("should set the 'to' email address correctly", function () {
    const testSubject = new Email('sender', 'arn:aws:ses:eu-west-1:123456789123:identity/johndoe@example.com', 'testing')
